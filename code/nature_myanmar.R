...
url <- "https://www.nature.com/search?q=myanmar%20amber&order=relevance&article_type=research&subject=palaeontology&date_range=2015-2020&page="
...
# Altmetrics
nature <- openxlsx::read.xlsx(file.path("output", "nature_myanmar.xlsx"))
...
write.csv(data.table::rbindlist(alt_mets, fill=TRUE), file.path("output", "alt_nature_myanmar.csv"), row.names = FALSE)
