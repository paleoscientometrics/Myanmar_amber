...
p <- ggplot() +
  ...
  annotate("rect", xmin=-9.5, xmax=28.2, ymin=35, ymax=61, fill=NA, col="#2d1b0cff")
...
p_eu <- ggplot() +
  ...
  geom_text(data = aff.plot[aff.plot$amber == "no"& aff.plot$count > 10,],
  ...
  geom_text(data = aff.plot[aff.plot$amber == "yes"& aff.plot$count > 10,],
